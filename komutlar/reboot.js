...
module.exports.run = async (bot, message, args) => { 
  ...
  var embed2 = new Discord.RichEmbed()   
      ...
      .setDescription('sadece sahibim bu komutu  kullanabilir! Yani  FGsalih#0951 ')
      .setColor('RED')  
  

  if(message.author.id !== "646456382626988044") return message.channel.sendEmbed(embed2)
     
  //Cortex botun reboot sistemi hadi h.o
  var embed = new Discord.RichEmbed()   
      .setTitle('**Merhaba Sahibim FGSALİH#0951,**')

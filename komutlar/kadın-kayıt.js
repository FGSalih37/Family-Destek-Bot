...
exports.run = async (client, message, args) => {
    ...
    let role = message.guild.roles.get(`730351301912952932`)// Kadın rol id
    let kayitsiz = message.guild.roles.get(`730349474957885470`)// Kayıtsız rol id
    let kayitci = message.guild.roles.get(`727929983825215579`)// Kayıtcı rol id
